...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
        ...
        .state('dashboards.publishHome', {
            url: "/publishhome",
            templateUrl: "views/publisHome.html",
            data: { pageTitle: 'Home' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
        ...
        .state('dashboards.addComment', {
            url: "/addComment",
            templateUrl: "views/addComment.html",
            data: { pageTitle: 'Add Comment' },
            params: {'id': null},
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
        ...
        .state('dashboards.eventMap', {
        url: "/eventMap",
        templateUrl: "views/eventMap.html",
        data: { pageTitle: 'Event Map' },
        params: {'id': null},
        resolve: {
            loadPlugin: function ($ocLazyLoad) {
                return $ocLazyLoad.load([
